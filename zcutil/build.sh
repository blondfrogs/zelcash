...
./autogen.sh
CONFIG_SITE="$PWD/depends/$HOST/share/config.site" ./configure --disable-test "$HARDENING_ARG" "$LCOV_ARG" "$TEST_ARG" "$MINING_ARG" "$PROTON_ARG" $CONFIGURE_FLAGS CXXFLAGS='-g'
"$MAKE" "$@" V=1